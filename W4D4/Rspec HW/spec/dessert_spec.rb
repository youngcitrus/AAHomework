...
describe Dessert do
  ...
  let(:brownie) {Dessert.new("brownie", 2, chef)}
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect {Dessert.new("boba", "milk tea", "chef")}.to raise_error(ArgumentError)
    end
  end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["chocolate", "flour", "baking soda", "eggs"]
  ...
  describe "#eat" do
    ...
    it "raises an error if the amount is greater than the quantity" do
      expect {brownie.eat(3)}.to raise_error("not enough left!")
    end
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(brownie.serve).to eq("Chef Tucker the Great Baker has made 2 brownies!")
    end
  end
